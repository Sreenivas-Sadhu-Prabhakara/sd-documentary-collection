package com.bank.bian.documentarycollection.model;
...
/**
 * The BIAN control record for this service domain: "Documentary Collection Procedure".
 *
 ...
 * to its asset type (Documentary Collection). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Documentary Collection Procedure";
